...
from numpy import array, float32, expand_dims, average, sqrt, argwhere, zeros, shape, pad
...
# def remove_overlapped_cells_x(all_cells, threshold=3, threshold2=5):
#     tracked_index = []
#     new_all_cells = []
#     for i, cell in enumerate(all_cells):
#         if i not in tracked_index:
...
#                 if j not in tracked_index:
#                     if i != j:
#                         dist = abs(cell[1] - cell_1[1])
#                         if dist <= threshold:
#                             if abs(cell[2] - cell_1[2]) < threshold2:
#                                 temp_i.append(cell_1)
#                                 tracked_index.append(j)
#             temp_i = average(array(temp_i), 0)
#             new_all_cells.append([temp_i[0], temp_i[1], temp_i[2]])
